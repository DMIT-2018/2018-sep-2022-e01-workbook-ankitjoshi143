...
using EmployeeRegistrationSystem;
#endregion
...
//  connectionString
var connectionStringWorkSchedule =
    builder.Configuration.GetConnectionString("WorklScheduleDB");
...
builder.Services.EmployeeSystemBackendDependencies(options =>
            options.UseSqlServer(connectionStringWorkSchedule));
